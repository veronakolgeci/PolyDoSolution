    ...
    public class ParentTasksControllerTests {
        ...
        public async Task CreateTask_ShouldReturnCreated() {
            try {
                ...
                Console.WriteLine($"Exception occurred on create task: {ex.Message}");
                throw;
            }
        }
        ...
        public async Task AddSubTask_ShouldReturnCreated() {
            try {
                ...
                Console.WriteLine($"Exception occurred on add subtask: {ex.Message}");
                throw;
            }
        }
        ...
        public async Task DeleteTask_ShouldReturnNoContent() {
            try {
                ...
                Console.WriteLine($"Exception occurred on delete task: {ex.Message}");
                throw;
            }
        }
    }
